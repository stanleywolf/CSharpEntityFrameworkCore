    ...
    class Program
    {
        static void Main(string[] args)
        {
            using (var connection = new SqlConnection(Configuration.ConnectionString))
            {
                ...
                var createTableMinionsVilians = @"CREATE TABLE MinionsVillains(MinionId INT FOREIGN KEY REFERENCES Minions(Id), VillainId INT FOREIGN KEY REFERENCES Villains(Id), CONSTRAINT PK_MinionsVillains PRIMARY KEY(MinionId, VillainId))";
           
                ExecuteNonQuery(connection, createTableCountries);
                ExecuteNonQuery(connection, createTableTowns);
                ExecuteNonQuery(connection, createTableMinions);
                ExecuteNonQuery(connection, createTableEvilnessFactors);
                ExecuteNonQuery(connection, createTableVillians);
                ExecuteNonQuery(connection, createTableMinionsVilians);
                ...
                var InsertIntoEvilnessFactor = @"INSERT INTO EvilnessFactors (Name) VALUES ('Super good'),('Good'),('Bad'), ('Evil'),('Super evil')";
                ...
                var InsertIntoMinionsVilians = @"INSERT INTO MinionsVillains (MinionId, VillainId) VALUES (4,2),(1,1),(5,7),(3,5),(2,6),(11,5),(8,4),(9,7),(7,1),(1,3),(7,3),(5,3),(4,3),(1,2),(2,1),(2,7)";
                ...
                ExecuteNonQuery(connection, InsertIntoMinionsVilians);
        ...
        {
            using (var command = new SqlCommand(databaseSql, connection))
            {
